...
class SingleViewto3D(nn.Module):
    def __init__(self, args):
        ...
        if args.type == "vox":
            ...
            self.decoder = PointNetwork(512, self.n_point)
        elif args.type == "mesh":
            # Input: b x 512
...
class PointNetwork(nn.Module):
    ...
    def __init__(self, input_size, n_points, dropout=0.1):
    ...
    def forward(self, x):
        ...
        num_batches = x.shape[0]
        x = x.reshape((num_batches, self.n_points, 3))
